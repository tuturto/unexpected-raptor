...
// Native classes
// Bound closures
$$.Bound__completeError__Future = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$2: function(p0, p1) {
    return this._liblib2$_target.call(this._self, p0, p1);
  },
...
$$.Bound__run__ZoneTimer = [P, {"": "BoundClosure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  call$0: function() {
    return this._liblib2$_target.call(this._self);
  },
  $is_void_: true
}];
...
$$.Closure$main = [E, {"": "Closure;call$0,$name", $is_void_: true}];

$$.Closure$onDataLoaded = [E, {"": "Closure;call$1,$name"}];
...
_EventLoop: {"": "Object;events,activeTimerCount",
  ...
  runIteration$0: function() {
    ...
    if ($event == null) {
      ...
      t1 = $globalState;
      if (t1.isWorker === true && t1.isolates._liblib$_length === 0 && t1.topEventLoop.activeTimerCount === 0) {
        t1 = t1.mainManager;
...
BoundClosure: {"": "Closure;_self,_liblib2$_target,_receiver,_liblib2$_name",
  $eq: function(_, other) {
    var t1;
    if (other == null)
      return false;
  ...
  get$hashCode: function(_) {
    ...
    return (receiverHashCode ^ H.Primitives_objectHashCode(this._liblib2$_target)) >>> 0;
  },
  $isBoundClosure: true
},
...
_Future__propagateToListeners_closure0: {"": "Closure;box_1,box_2,hasError_4,listener_5",
  call$0: function() {
    ...
    try {
      t1 = this.box_2;
      if (!this.hasError_4) {
        value = t1.source_4.get$_liblib1$_value();
        t1 = this.listener_5;
...
_HashMap: {"": "Object;_liblib$_length,_strings,_nums,_rest,_keys",
  get$length: function(_) {
  ...
  _computeKeys$0: function() {
    ...
    if (t1 != null)
      return t1;
    result = P.List_List(this._liblib$_length, null);
    strings = this._strings;
    if (strings != null) {
...
_LinkedHashMap: {"": "Object;_liblib$_length,_strings,_nums,_rest,_first,_last,_modifications",
  get$length: function(_) {
    return this._liblib$_length;
  },
  get$keys: function() {
...
_LinkedIdentityHashMap: {"": "_LinkedHashMap;_liblib$_length,_strings,_nums,_rest,_first,_last,_modifications",
  _findBucketIndex$2: function(bucket, key) {
    var $length, i, t1;
    if (bucket == null)
      return -1;
...
_LinkedCustomHashMap: {"": "_LinkedHashMap;_equals,_hashCode,_validKey,_liblib$_length,_strings,_nums,_rest,_first,_last,_modifications",
...
InputElement: {"": "HtmlElement;", $asObject: null},
...
TableRowElement: {"": "HtmlElement;",
  ...
  _insertCell$1: function(receiver, index) {
    return receiver.insertCell(index);
  }
},
...
loadData: function() {
  W.HttpRequest_getString("http://127.0.0.1:8000/gm/log_entries/3068/03/", null, null).then$1(E.onDataLoaded$closure);
},

onDataLoaded: function(jsonString) {
  J.forEach$1$ax(J.$index$asx(P.parse(jsonString, null), "entries"), new E.onDataLoaded_closure());
},

addLogEntry: function(date, entry) {
  var row, t1;
  row = J.insertRow$1$x(document.querySelector("#log_table"), -1);
  t1 = J.getInterceptor$x(row);
  t1.insertCell$1(row, 0).textContent = date;
  t1._insertCell$1(row, 1).textContent = entry;
},

onDataLoaded_closure: {"": "Closure;",
  call$1: function(entry) {
    var t1 = J.getInterceptor$asx(entry);
    return E.addLogEntry(t1.$index(entry, "entry_date"), t1.$index(entry, "text"));
  },
  $asObject: null
}},
1],
...
init.globalFunctions.main$closure = E.main$closure = new E.Closure$main(E.main, "main$closure");
init.globalFunctions.onDataLoaded$closure = E.onDataLoaded$closure = new E.Closure$onDataLoaded(E.onDataLoaded, "onDataLoaded$closure");
...
function dart_precompiled($collectedClasses) {
  ...
  function BoundClosure(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  }
  ...
  function Bound__completeError__Future(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function _ZoneTimer(_zone, _liblib1$_callback, _timer) {
    this._zone = _zone;
  ...
  function Bound__run__ZoneTimer(_self, _liblib2$_target, _receiver, _liblib2$_name) {
    this._self = _self;
    this._liblib2$_target = _liblib2$_target;
    this._receiver = _receiver;
    this._liblib2$_name = _liblib2$_name;
  ...
  function _HashMap(_liblib$_length, _strings, _nums, _rest, _keys) {
  ...
  function _LinkedHashMap(_liblib$_length, _strings, _nums, _rest, _first, _last, _modifications) {
    this._liblib$_length = _liblib$_length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
  ...
  function _LinkedIdentityHashMap(_liblib$_length, _strings, _nums, _rest, _first, _last, _modifications) {
    this._liblib$_length = _liblib$_length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
  ...
  function _LinkedCustomHashMap(_equals, _hashCode, _validKey, _liblib$_length, _strings, _nums, _rest, _first, _last, _modifications) {
  ...
  function _ListQueueIterator(_queue, _end, _modificationCount, _position, _liblib$_current) {
    this._queue = _queue;
    this._end = _end;
    this._modificationCount = _modificationCount;
  ...
  function onDataLoaded_closure() {
  }
  onDataLoaded_closure.builtin$cls = "onDataLoaded_closure";
  if (!"name" in onDataLoaded_closure)
    onDataLoaded_closure.name = "onDataLoaded_closure";
  $desc = $collectedClasses.onDataLoaded_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  onDataLoaded_closure.prototype = $desc;
