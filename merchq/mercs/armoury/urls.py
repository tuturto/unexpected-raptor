...
urlpatterns = patterns('',
    url(r'^$',
        views.index,
        name='mercs.armoury.index'),
    url(r'^(?P<force_id>\d+)/$',
        views.force_armoury,
        name='mercs.armoury.force_armoury'),
    url(r'^vehicle/(?P<vehicle_id>\d+)/$',
        views.vehicle_details,
        name='mercs.armoury.vehicle'),
    url(r'^vehicle/sell/(?P<vehicle_id>\d+)/$',
        views.sell_vehicle,
        name='mercs.armoury.sell_vehicle'),
    url(r'^vehicle/sell/(?P<vehicle_id>\d+)/(?P<confirmed>[a-z]+)/$', 
        views.sell_vehicle, 
        name='mercs.armoury.sell_vehicle_confirmed'),
)
